var tryServerCompression = false;
    ...
    function(e) {
        ...
        return function e(t, n, o) {
            ...
            2: [function(e, t, n) {
                ...
                for (var l = new i.Buf8(256), d = 0; 256 > d; d++) l[d] = d >= 252 ? 6 : d >= 248 ? 5 : d >= 240 ? 4 : d >= 224 ? 3 : d >= 192 ? 2 : 1;
                l[254] = l[254] = 1, n.string2buf = function(e) {
                    var t, n, o, a, r, s = e.length,
                        l = 0;
                    for (a = 0; s > a; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), a++)), l += 128 > n ? 1 : 2048 > n ? 2 : 65536 > n ? 3 : 4;
                    for (t = new i.Buf8(l), r = 0, a = 0; l > r; a++) n = e.charCodeAt(a), 55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), a++)), 128 > n ? t[r++] = n : 2048 > n ? (t[r++] = 192 | n >>> 6, t[r++] = 128 | 63 & n) : 65536 > n ? (t[r++] = 224 | n >>> 12, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n) : (t[r++] = 240 | n >>> 18, t[r++] = 128 | n >>> 12 & 63, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n);
                    return t
                    ...
                    var n, i, a, r, s = t || e.length,
                        d = new Array(2 * s);
                    for (i = 0, n = 0; s > n;)
                        if (a = e[n++], 128 > a) d[i++] = a;
                        else if (r = l[a], r > 4) d[i++] = 65533, n += r - 1;
                    else {
                        for (a &= 2 === r ? 31 : 3 === r ? 15 : 7; r > 1 && s > n;) a = a << 6 | 63 & e[n++], r--;
                        r > 1 ? d[i++] = 65533 : 65536 > a ? d[i++] = a : (a -= 65536, d[i++] = 55296 | a >> 10 & 1023, d[i++] = 56320 | 1023 & a)
                    }
                    return o(d, i)
            ...
            7: [function(e, t, n) {
                ...
                t.exports = function(e, t) {
                    var n, a, r, s, l, d, u, c, f, h, m, p, b, w, g, v, k, y, _, x, S, M, C, E, R;
                    n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, R = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, m = n.window, p = n.hold, b = n.bits, w = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                    e: do {
                        15 > b && (p += E[a++] << b, b += 8, p += E[a++] << b, b += 8), y = w[p & v];
                        t: for (;;) {
                            if (_ = y >>> 24, p >>>= _, b -= _, _ = y >>> 16 & 255, 0 === _) R[s++] = 65535 & y;
                            else {
                                if (!(16 & _)) {
                                    if (0 === (64 & _)) {
                                        y = w[(65535 & y) + (p & (1 << _) - 1)];
                                ...
                                x = 65535 & y, _ &= 15, _ && (_ > b && (p += E[a++] << b, b += 8), x += p & (1 << _) - 1, p >>>= _, b -= _), 15 > b && (p += E[a++] << b, b += 8, p += E[a++] << b, b += 8), y = g[p & k];
                                n: for (;;) {
                                    ...
                                    if (S = 65535 & y, _ &= 15, _ > b && (p += E[a++] << b, b += 8, _ > b && (p += E[a++] << b, b += 8)), S += p & (1 << _) - 1, S > u) {
                                        e.msg = "invalid distance too far back", n.mode = o;
                                        break e
                                    }
                                    if (p >>>= _, b -= _, _ = s - l, S > _) {
                                        if (_ = S - _, _ > f && n.sane) {
                                            e.msg = "invalid distance too far back", n.mode = o;
                                            break e
                                        }
                    ...
                    x = b >> 3, a -= x, b -= x << 3, p &= (1 << b) - 1, e.next_in = a, e.next_out = s, e.avail_in = r > a ? 5 + (r - a) : 5 - (a - r), e.avail_out = d > s ? 257 + (d - s) : 257 - (s - d), n.hold = p, n.bits = b
                }
            }, {}],
            8: [function(e, t, n) {
                "use strict";
                ...
                function a(e) {
                    var t;
                    return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = U, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(me), t.distcode = t.distdyn = new w.Buf32(pe), t.sane = 1, t.back = -1, R) : L
                }
                ...
                function l(e, t) {
                    var n, o;
                    return e ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== R && (e.state = null), n) : L
                }
                ...
                function u(e) {
                    if (ge) {
                        ...
                        for (y(x, e.lens, 0, 288, p, 0, e.work, {
                                bits: 9
                            }), t = 0; 32 > t;) e.lens[t++] = 5;
                        y(S, e.lens, 0, 32, b, 0, e.work, {
                            bits: 5
                        }), ge = !1
                    }
                ...
                function f(e, t) {
                    var n, i, a, r, s, l, d, f, h, m, p, b, me, pe, be, we, ge, ve, ke, ye, _e, xe, Se, Me, Ce = 0,
                        Ee = new w.Buf8(4),
                        Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                    if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return L;
                    n = e.state, n.mode === J && (n.mode = K), s = e.next_out, a = e.output, d = e.avail_out, r = e.next_in, i = e.input, l = e.avail_in, f = n.hold, h = n.bits, m = l, p = d, xe = R;
                    e: for (;;) switch (n.mode) {
                        case U:
                            if (0 === n.wrap) {
                                n.mode = K;
                        ...
                        case Z:
                            ...
                            n.head && (n.head.time = f), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, Ee[2] = f >>> 16 & 255, Ee[3] = f >>> 24 & 255, n.check = v(n.check, Ee, 4, 0)), f = 0, h = 0, n.mode = P;
                        case P:
                            for (; 16 > h;) {
                                if (0 === l) break e;
                                l--, f += i[r++] << h, h += 8
                            }
                            n.head && (n.head.xflags = 255 & f, n.head.os = f >> 8), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0, n.mode = T;
                        case T:
                            if (1024 & n.flags) {
                                for (; 16 > h;) {
                                    if (0 === l) break e;
                            ...
                            n.mode = N;
                        case N:
                            if (1024 & n.flags && (b = n.length, b > l && (b = l), b && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), w.arraySet(n.head.extra, i, r, b, _e)), 512 & n.flags && (n.check = v(n.check, i, b, r)), l -= b, r += b, n.length -= b), n.length)) break e;
                            n.length = 0, n.mode = q;
                        case q:
                            if (2048 & n.flags) {
                                if (0 === l) break e;
                                b = 0;
                                do _e = i[r + b++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && l > b);
                                if (512 & n.flags && (n.check = v(n.check, i, b, r)), l -= b, r += b, _e) break e
                        ...
                        case G:
                            if (4096 & n.flags) {
                                if (0 === l) break e;
                                b = 0;
                                do _e = i[r + b++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && l > b);
                                if (512 & n.flags && (n.check = v(n.check, i, b, r)), l -= b, r += b, _e) break e
                        ...
                        case V:
                            if (b = n.length) {
                                ...
                                w.arraySet(a, i, r, b, s), l -= b, r += b, d -= b, s += b, n.length -= b;
                                break
                            }
                            n.mode = J;
                            break;
                        ...
                        case ne:
                            if (l >= 6 && d >= 258) {
                                e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, k(e, p), s = e.next_out, a = e.output, d = e.avail_out, r = e.next_in, i = e.input, l = e.avail_in, f = n.hold, h = n.bits, n.mode === J && (n.back = -1);
                                break
                            }
                        ...
                        case le:
                            if (n.wrap) {
                                ...
                                if (p -= d, e.total_out += p, n.total += p, p && (e.adler = n.check = n.flags ? v(n.check, a, p, s - p) : g(n.check, a, p, s - p)), p = d, (n.flags ? f : o(f)) !== n.check) {
                    ...
                    return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe, z) : (m -= e.avail_in, p -= e.avail_out, e.total_in += m, e.total_out += p, n.total += p, n.wrap && p && (e.adler = n.check = n.flags ? v(n.check, a, p, e.next_out - p) : g(n.check, a, p, e.next_out - p)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === m && 0 === p || t === M) && xe === R && (xe = B), xe)
                }
                ...
                var p, b, w = e("../utils/common"),
                    ...
                    we = be,
                    ge = !0;
                n.inflateReset = r, n.inflateReset2 = s, n.inflateResetKeep = a, n.inflateInit = d, n.inflateInit2 = l, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = m, n.inflateInfo = "pako inflate (from Nodeca project)"
            }, {
                "../utils/common": 1,
                "./adler32": 3,
                "./crc32": 5,
            ...
            9: [function(e, t, n) {
                ...
                t.exports = function(e, t, n, m, p, b, w, g) {
                    var v, k, y, _, x, S, M, C, E, R = g.bits,
                        ...
                        j = 0;
                    for (F = 0; i >= F; F++) N[F] = 0;
                    for (D = 0; m > D; D++) N[t[n + D]]++;
                    for (z = R, A = i; A >= 1 && 0 === N[A]; A--);
                    if (z > A && (z = A), 0 === A) return p[b++] = 20971520, p[b++] = 20971520, g.bits = 1, 0;
                    for (L = 1; A > L && 0 === N[L]; L++);
                    for (L > z && (z = L), U = 1, F = 1; i >= F; F++)
                        if (U <<= 1, U -= N[F], 0 > U) return -1;
                    if (U > 0 && (e === s || 1 !== A)) return -1;
                    for (q[1] = 0, F = 1; i > F; F++) q[F + 1] = q[F] + N[F];
                    for (D = 0; m > D; D++) 0 !== t[n + D] && (w[q[t[n + D]]++] = D);
                    if (e === s ? (P = G = w, S = 19) : e === l ? (P = u, T -= 257, G = c, j -= 257, S = 256) : (P = f, G = h, S = -1), Z = 0, D = 0, F = L, x = b, B = z, I = 0, y = -1, O = 1 << z, _ = O - 1, e === l && O > a || e === d && O > r) return 1;
                    for (var H = 0;;) {
                        H++, M = F - I, w[D] < S ? (C = 0, E = w[D]) : w[D] > S ? (C = G[j + w[D]], E = P[T + w[D]]) : (C = 96, E = 0), v = 1 << F - I, k = 1 << B, L = k;
                        do k -= v, p[x + (Z >> I) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
                        for (v = 1 << F - 1; Z & v;) v >>= 1;
                        ...
                        if (F > z && (Z & _) !== y) {
                            ...
                            if (O += 1 << B, e === l && O > a || e === d && O > r) return 1;
                            y = Z & _, p[y] = z << 24 | B << 16 | x - b | 0
                        }
                    }
                    return 0 !== Z && (p[x + Z] = F - I << 24 | 64 << 16 | 0), g.bits = z, 0
                }
            }, {
                "../utils/common": 1
            }],
            ...
            "/lib/inflate.js": [function(e, t, n) {
                ...
                h.prototype.push = function(e, t) {
                    ...
                    do {
                        if (0 === c.avail_out && (c.output = new r.Buf8(h), c.next_out = 0, c.avail_out = h), n = a.inflate(c, l.Z_NO_FLUSH), n !== l.Z_STREAM_END && n !== l.Z_OK) return this.onEnd(n), this.ended = !0, !1;
                        c.next_out && (0 === c.avail_out || n === l.Z_STREAM_END || 0 === c.avail_in && (o === l.Z_FINISH || o === l.Z_SYNC_FLUSH)) && ("string" === this.options.to ? (i = s.utf8border(c.output, c.next_out), d = c.next_out - i, u = s.buf2string(c.output, i), c.next_out = d, c.avail_out = h - d, d && r.arraySet(c.output, c.output, i, d, 0), this.onData(u)) : this.onData(r.shrinkBuf(c.output, c.next_out)))
                    } while (c.avail_in > 0 && n !== l.Z_STREAM_END);
                    return n === l.Z_STREAM_END && (o = l.Z_FINISH), o === l.Z_FINISH ? (n = a.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === l.Z_OK) : o === l.Z_SYNC_FLUSH ? (this.onEnd(l.Z_OK), c.avail_out = 0, !0) : !0
        ...
        var e = function(e) {
            ...
            function n() {
                ...
                function n(n) {
                    ...
                    t.prototype.byteArray = o, t.prototype.requests["/data.unity3d"].onload(), t.prototype.requests["/methods_pointedto_by_uievents.xml"].onload(), t.prototype.requests["/Il2CppData/Metadata/global-metadata.dat"].onload(), t.prototype.requests["/Resources/unity_default_resources"].onload(), t.prototype.requests["/Managed/mono/2.0/machine.config"].onload(), Module.removeRunDependency("datafile_bungusland.data")
                }
                ...
                }, new t(0, 11490524, 0, 0).open("GET", "/data.unity3d"), new t(11490524, 11491142, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(11491142, 12708118, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(12708118, 14204810, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(14204810, 14232436, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_bungusland.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, l ? (n(l), l = null) : d = n
            }
            var o;
